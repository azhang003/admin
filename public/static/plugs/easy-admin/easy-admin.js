    ...
    var admin = {
        ...
        common: {
            ...
            handleCutZero: function (num) {
                ...
                //判断是否有效数
                if (!parseFloat(num) && num.indexOf('.') > -1) {
                    //循环小数部分
                    for (let i = leng; i > 0; i--) {
                        ...
                        if (
                            ...
                            //如果末尾没有0
                            return parseFloat(newstr).toFixed(5);
                        }
                    }
                }
        ...
        table: {
            ...
            money: function (data, option) {
                ...
                return '<em>' + option.symbol +':</em><span style="color: #0000FF;margin-left: 15px;font-size:14px">' + admin.common.handleCutZero(value) + '</span>';
            },
