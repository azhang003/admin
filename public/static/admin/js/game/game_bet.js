define(["jquery", "easy-admin"], function ($, ea) {
    ...
    var init = {
        ...
        index_url: 'game.game_bet/index',
        add_url: 'game.game_bet/add',
        edit_url: 'game.game_bet/edit',
        delete_url: 'game.game_bet/delete',
        export_url: 'game.game_bet/export',
        modify_url: 'game.game_bet/modify',
    };
        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    // {field: 'type', width: 150, title: '交易类型', search: 'select', selectList: {1:"模拟交易",0:"真实交易"}},
                    {
