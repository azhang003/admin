    ...
    public function getTypeBetsDetail()
    {
        ...
        foreach ($data as $MemberBets) {
            ...
            if ($MemberBets['bet'] == 1) {
                ...
                $Downexcess_amountaa = bcsub($MemberBets['money'] , $Downproportionss,8);                 //超出金额
        ...
        if ($Downexcess_amount > 0) {
            $excess_proportion = bcdiv($Downexcess_amount , ($Downproportion != 0 ? $Downproportion : 1),8);                 //超出比例
        ...
        foreach ($this->AllMembersBets as $MemberBets) {
            ...
            if (count($MemberBes) > 1) {
                $edit = array_column($MemberBes, 'money');
                array_multisort($edit, SORT_DESC, $MemberBes);
            }
            $MemberUp = 0;
            $MemberDown = 0;
